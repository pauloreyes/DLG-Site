			...
			<div className='flex items-center justify-center h-screen'>
				<div className='w-[90%] flex items-center  flex-col md:flex-row mt-5 md:w-[900px] md:h-[450px] bg-white rounded-lg text-[#26235d]'>
					...
					<div className='m-2 p-1 md:w-[45%]'>
						...
						<p className='text-sm'>
							Let us know what you need. Reach out to us by filling out the form or
							head straight to our Learning as a Service Estimator app for a quick
							evaluation of your training needs.
						</p>
